...
F(2*size(nodes,1)) = 10;
[Max_ndM, BuckleRatio,Stress,Force,L] = TrussSolve2(nodes,conn,nnt,a,b,F);
...
csvwrite('nodes2.csv',nodes)
csvwrite('connectivity2.csv',conn)
csvwrite('height2.csv',a)
csvwrite('width2.csv',b)
